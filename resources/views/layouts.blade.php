<html lang="en" data-bs-theme="light">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body  data-bs-theme="dark" id="kt_body" class="app-blank" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">


        	<div id="kt_app_header" class="app-header d-flex" data-kt-sticky="true" data-kt-sticky-activate-="true" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="app-header-wrapper d-flex flex-stack w-100">
							...
							<div id="kt_app_header_page_title_wrapper">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
									<!--begin::Title-->
									<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center me-3 my-0">Si Halal</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
							</div>
							...
							<div class="app-navbar flex-stack flex-shrink-0" id="kt_app_aside_navbar">
								...
								<div class="d-flex align-items-center me-5 me-lg-10">
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="d-flex flex-column">
														<div class="fw-bold d-flex align-items-center fs-5">Pramudita Ahmad
														<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">hehe</span></div>
														<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">pramudita5800@gmail.com</a>
													</div>
													<!--end::Username-->
												</div>
											</div>
									...
									<!--begin:Info-->
									<div class="d-flex flex-column">
										<a href="../../demo25/dist/pages/user-profile/overview.html" class="app-navbar-user-name text-gray-900 text-hover-primary fs-5 fw-bold">Pramudita Ahmad</a>
										<span class="app-navbar-user-info text-gray-600 fw-semibold fs-7">Ea</span>
									</div>
									<!--end:Info-->
								</div>
								<!--end:Author-->
								...
								<div class="app-navbar-item">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
										...
										<div class="row g-0">
											<!--begin:Item-->
											<div class="col-6">
												<a href="../../demo25/dist/apps/projects/budget.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
											...
											<!--begin:Item-->
											<div class="col-6">
												<a href="../../demo25/dist/apps/projects/settings.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
											...
											<!--begin:Item-->
											<div class="col-6">
												<a href="../../demo25/dist/apps/projects/list.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
											...
											<!--begin:Item-->
											<div class="col-6">
												<a href="../../demo25/dist/apps/projects/users.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
										...
										<div class="py-2 text-center border-top">
											<a href="../../demo25/dist/pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All
										...
										<div class="menu-sub menu-sub-dropdown px-2 py-4 w-250px mh-75 overflow-auto">
											...
											<div class="menu-item">
												...
												<div class="menu-content">
													<span class="menu-section fs-5 fw-bolder ps-1 py-1"><a href="/api/datalist">Home</a></span>
												</div>
												<!--end:Menu content-->
											</div>
											<!--end:Menu item-->
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="/api/dashboard">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item py-2">
										...
										<div class="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px mh-75 overflow-auto">
											...
											<div class="menu-item">
												...
												<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="/api/datalist">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Datalist</span>
												</a>
												<!--end:Menu link-->
											</div>
										</div>
