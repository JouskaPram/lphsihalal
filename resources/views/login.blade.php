...
@section('content')
				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						<div class="w-lg-500px p-10">
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="/api/login">
								<!--begin::Heading-->
								<div class="text-center mb-11">
									...
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6">System Datalist</div>
									<!--end::Subtitle=-->
								</div>
								<!--begin::Heading--
								<!--begin::Separator-->
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<input type="text" placeholder="Email"  autocomplete="off" id="userid" name="userid" for="userid" class="form-control bg-transparent" />
									
								</div>
								
								<div class="fv-row mb-3">
								
									<input type="password" placeholder="Password" name="password" id="password" for="password" autocomplete="off" class="form-control bg-transparent" />
		...
		<script src="https://unpkg.com/metronic-graphite@0.2.0/src/index.js"></script>
