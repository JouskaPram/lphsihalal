    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <form action="/api/jadwal/{{$id}}/{{$up}}" method="post" >
                    @csrf
                    @method('PUT')
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                ...
                                <input type="date" name="dari" id="" value="{{str_replace("T00:00:00.000Z","",$singlejadwal["jadwal_awal"])}}" class="form-control form-control-lg form-control-solid">
                            </div>
                            <!--end::Col-->
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="date" name="sampai" value="{{str_replace("T00:00:00.000Z","",$singlejadwal["jadwal_akhir"])}}" class="form-control form-control-lg form-control-solid" value="" >
