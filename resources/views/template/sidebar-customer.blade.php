    ...
    <div class="app-sidebar-navs flex-column-fluid py-6" id="kt_app_sidebar_navs">
        <div id="kt_app_sidebar_navs_wrappers" class="app-sidebar-wrapper hover-scroll-y my-2" data-kt-scroll="true"
            ...
            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                ...
                <!--begin:Menu item-->
                <div class="menu-item">
                    <a href="{{route('customer.dashboard')}}" class="menu-link {{$config['menu_active'] == 'dashboard' ? 'active' : ''}}">
                ...
                <div class="menu-item">
                    <a href="{{route('customer.halal-register')}}" class="menu-link {{$config['menu_active'] == 'halal-reg' ? 'active' : ''}}">
                        <span class="menu-icon">
                            <i class="fonticon-house fs-2"></i>
                        </span>
                        <span class="menu-title">Halal Registration</span>
                    </a>
                </div>
                <!--end:Menu item-->
            </div>
